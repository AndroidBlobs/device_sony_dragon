...
include $(CLEAR_VARS)
LOCAL_MODULE       := customized_media_copy.sh
LOCAL_MODULE_TAGS  := optional
LOCAL_MODULE_CLASS := ETC
LOCAL_SRC_FILES    := bin/customized_media_copy.sh
...
include $(CLEAR_VARS)
LOCAL_MODULE       := preloads_media_copy.sh
LOCAL_MODULE_TAGS  := optional
LOCAL_MODULE_CLASS := ETC
LOCAL_SRC_FILES    := bin/preloads_media_copy.sh
LOCAL_MODULE_PATH  := $(TARGET_OUT_VENDOR_EXECUTABLES)
include $(BUILD_PREBUILT)
