...
# GPS
PRODUCT_COPY_FILES += \
    $(LOCAL_PATH)/configs/gps/wpa_supplicant.conf:$(TARGET_COPY_OUT_VENDOR)/etc/wpa_supplicant.conf \
...
# Ramdisk
PRODUCT_PACKAGES += \
    customized_media_copy.sh \
    multi-cdf-symlinker.sh \
    ota-config-updater.sh \
    preloads_media_copy.sh \
...
# Inherit vendor
$(call inherit-product, vendor/sony/dragon/dragon-vendor.mk)